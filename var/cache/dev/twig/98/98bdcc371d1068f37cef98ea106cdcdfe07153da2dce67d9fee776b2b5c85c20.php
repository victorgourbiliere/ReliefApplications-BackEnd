...
class __TwigTemplate_d5f30b31088e863111a9e65f3b2083f9d95fbe44c92c6f268e28d8bb2648de3e extends \Twig\Template
{
    ...
    <?php \$help = false !== \$translation_domain ? \$pages['translator']->trans(\$help, \$help_translation_parameters, \$translation_domain) : \$help; ?>
    <?php \$help = false === \$help_html ? \$pages->escape(\$help) : \$help ?>
    <p id=\"<?php echo \$pages->escape(\$id); ?>_help\" <?php echo ' '.\$pages['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
";
    ...
    <p id=\"<?php echo \$pages->escape(\$id); ?>_help\" <?php echo ' '.\$pages['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "C:\\Users\\victor\\Desktop\\InterviewInternship_ReliefApplications\\Etape2\\Front-End\\FullStack\\my-project\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\form_help.html.php");
    }
}
