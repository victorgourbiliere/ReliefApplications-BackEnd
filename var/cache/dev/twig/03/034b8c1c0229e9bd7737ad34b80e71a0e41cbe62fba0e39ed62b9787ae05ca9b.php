...
<?php else: ?>
    <div <?php echo \$pages['form']->block(\$form, 'widget_container_attributes') ?>>
        ...
        echo "'], [
            \$pages['form']->widget(\$form['year']),
            \$pages['form']->widget(\$form['month']),
            \$pages['form']->widget(\$form['day']),
        ], \$date_pattern) ?>
    </div>
<?php endif ?>
";
...
<?php endif ?>
", "@Framework/Form/date_widget.html.php", "C:\\Users\\victor\\Desktop\\InterviewInternship_ReliefApplications\\Etape2\\Front-End\\FullStack\\my-project\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\date_widget.html.php");
    }
}
