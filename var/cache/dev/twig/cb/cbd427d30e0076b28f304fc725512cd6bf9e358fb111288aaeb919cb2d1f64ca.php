...
<?php printf('%s=\"%s\" ', \$pages->escape(\$k), \$pages->escape(false !== \$translation_domain ? \$pages['translator']->trans(\$v, \$attr_translation_parameters, \$translation_domain) : \$v)) ?>
<?php elseif (true === \$v): ?>
<?php printf('%s=\"%s\" ', \$pages->escape(\$k), \$pages->escape(\$k)) ?>
<?php elseif (false !== \$v): ?>
<?php printf('%s=\"%s\" ', \$pages->escape(\$k), \$pages->escape(\$v)) ?>
<?php endif ?>
<?php endforeach ?>
";
...
<?php endif ?>
<?php endforeach ?>
", "@Framework/Form/attributes.html.php", "C:\\Users\\victor\\Desktop\\InterviewInternship_ReliefApplications\\Etape2\\Front-End\\FullStack\\my-project\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\attributes.html.php");
    }
}
