...
class __TwigTemplate_2de2cfb4fda017740e840d25d6055b0ab7f7d2ab6efe1cd5dfcdd8f4f2908fc0 extends \Twig\Template
{
    ...
    : \$pages['form']->humanize(\$name); } ?>
<button type=\"<?php echo isset(\$type) ? \$pages->escape(\$type) : 'button' ?>\" <?php echo \$pages['form']->block(\$form, 'button_attributes') ?>><?php echo \$pages->escape(false !== \$translation_domain ? \$pages['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></button>
";
    ...
    : \$pages['form']->humanize(\$name); } ?>
<button type=\"<?php echo isset(\$type) ? \$pages->escape(\$type) : 'button' ?>\" <?php echo \$pages['form']->block(\$form, 'button_attributes') ?>><?php echo \$pages->escape(false !== \$translation_domain ? \$pages['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></button>
", "@Framework/Form/button_widget.html.php", "C:\\Users\\victor\\Desktop\\InterviewInternship_ReliefApplications\\Etape2\\Front-End\\FullStack\\my-project\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\button_widget.html.php");
    }
}
