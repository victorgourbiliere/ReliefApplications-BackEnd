...
class __TwigTemplate_c90756fa377d0e177cbe7d750e95535bac43f7f73c6952e11ae89ec196786370 extends \Twig\Template
{
    ...
    <td>
        <?php echo \$pages['form']->label(\$form); ?>
    </td>
    <td>
        <?php echo \$pages['form']->errors(\$form); ?>
        <?php echo \$pages['form']->widget(\$form, \$widgetAttr); ?>
        <?php echo \$pages['form']->help(\$form); ?>
    </td>
</tr>
";
...
", "@Framework/FormTable/form_row.html.php", "C:\\Users\\victor\\Desktop\\InterviewInternship_ReliefApplications\\Etape2\\Front-End\\FullStack\\my-project\\vendor\\symfony\\framework-bundle\\Resources\\views\\FormTable\\form_row.html.php");
    }
}
