...
<label<?php if (\$label_attr) { echo ' '.\$pages['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$pages->escape(false !== \$translation_domain ? \$pages['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
";
...
<label<?php if (\$label_attr) { echo ' '.\$pages['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$pages->escape(false !== \$translation_domain ? \$pages['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "C:\\Users\\victor\\Desktop\\InterviewInternship_ReliefApplications\\Etape2\\Front-End\\FullStack\\my-project\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\form_label.html.php");
    }
}
