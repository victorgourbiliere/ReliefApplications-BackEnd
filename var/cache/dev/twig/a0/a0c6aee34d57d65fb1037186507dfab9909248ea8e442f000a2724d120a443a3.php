...
class __TwigTemplate_7d9a7efb0add6c7c27c6cb2197a9571ce3922488994c0b45dd1399819f700321 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "<?php echo \$pages['form']->start(\$form) ?>
    <?php echo \$pages['form']->widget(\$form) ?>
<?php echo \$pages['form']->end(\$form) ?>
";
    ...
    {
        return new Source("<?php echo \$pages['form']->start(\$form) ?>
    <?php echo \$pages['form']->widget(\$form) ?>
<?php echo \$pages['form']->end(\$form) ?>
", "@Framework/Form/form.html.php", "C:\\Users\\victor\\Desktop\\InterviewInternship_ReliefApplications\\Etape2\\Front-End\\FullStack\\my-project\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\form.html.php");
    }
}
