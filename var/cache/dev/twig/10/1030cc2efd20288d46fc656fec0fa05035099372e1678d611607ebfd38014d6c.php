...
class __TwigTemplate_b4439858f9ac4c4470c390108e5e4527d0bd24dbe7d09977b5cc6f923c183874 extends \Twig\Template
{
    ...
    <?php echo \$pages['form']->block(\$form, 'form_widget_simple'); ?>
<?php else: ?>
    <?php \$vars = \$widget == 'text' ? ['attr' => ['size' => 1]] : [] ?>
    <div <?php echo \$pages['form']->block(\$form, 'widget_container_attributes') ?>>
        <?php
            // There should be no spaces between the colons and the widgets, that's why
            // this block is written in a single PHP tag
            echo \$pages['form']->widget(\$form['hour'], \$vars);

            if (\$with_minutes) {
                echo ':';
                echo \$pages['form']->widget(\$form['minute'], \$vars);
            }

            if (\$with_seconds) {
                echo ':';
                echo \$pages['form']->widget(\$form['second'], \$vars);
            }
        ?>
    </div>
<?php endif ?>
...
<?php endif ?>
", "@Framework/Form/time_widget.html.php", "C:\\Users\\victor\\Desktop\\InterviewInternship_ReliefApplications\\Etape2\\Front-End\\FullStack\\my-project\\vendor\\symfony\\framework-bundle\\Resources\\views\\Form\\time_widget.html.php");
    }
}
